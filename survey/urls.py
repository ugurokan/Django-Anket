...
urlpatterns = [
    ...
    path("logout/", views.survey.logout_view, name="logout"),
    ...
    path("surveys/<int:pk>/download/", views.survey.download_excel, name="download"),
    ...
    path("surveys/<int:pk>/slayt/", views.survey.slayt, name="survey-slayt"),
